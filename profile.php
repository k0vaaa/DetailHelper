	...
	<header class="header">
			...
			<div class="header_section">
				<div class="header_item">
					<a href="main_authorized.php">На главную</a>
				</div>
...
<!--				<h1>Личный кабинет</h1>-->
				<div class="profile">
					<div class="info">
						...
						<p>Почта: <span><?=$_SESSION['user']['email']?></span></p>
					...
					<div class="order">
                        ...
                        <p id="emptycart">Корзина пуста, обратитесь к нашему <a href="main_authorized.php">каталогу</a>!</p>
				</div>
