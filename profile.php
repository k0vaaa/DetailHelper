...
<div class="backpic">
    <div class="containerforprof">
        ...
        <div class="blockforall">
            <a id="back" href="../main_authorized.php">Вернуться на главную &#129042;</a>
            <div class="profile">
                <div class="info">
                ...
                <div class="history">
                    ...
                    <div class="historyoutput">
                        ...
                        if (mysqli_num_rows($result) == 0) {
                            ?><p id="emptystory">Пока что история Ваших заказов пуста. Информация о заказах появится как только вы
                                их совершите.</p><?
                        } else {
                            ?>
                            <div class="table_responsive1">
                                ...
                                <table class="table">
                                    ...
                                    <tbody><? while ($orderInfo = $result->fetch_assoc()) {
                                        $orders[0] = $orderInfo;
                ...
                <div class="order">
                    ...
                    <p id="emptycart">Корзина пуста, обратитесь к нашему <a id="empycartlink" href="main_authorized.php#secondblock">каталогу</a> !
                    </p>
