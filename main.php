...
<header class="header"> <!-- контейнер "шапка", содержащий навигацию-->
    ...
    <div id="anchors" class="header_section">
        ...
        <div class="header_item">
            <a id="toinfo" href="#thirdblock">О нас</a>
        </div>
        <div class="header_item">
                ...
                <div class="headercart__body">
                    ...
                    <div class="headercart__body__content">
                        ...
                        <div class="orderheaderbtns">
                            <a id="button1" href="#popup3">Быстрый заказ</a>
                                ...
                                <div class="popup__content">
                                    ...
                                    <div class="popup__fill">
                                        <form action="/form-lesson/mail.php" method="post">
                                            <input value="" name="name" type="text" placeholder="Введите ваше ФИО">
                                            <input value="" name="email" type="text" placeholder="Введите адрес электронной почты">
