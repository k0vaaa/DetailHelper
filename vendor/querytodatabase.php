...
$result1 = mysqli_query($connect,"SELECT DISTINCT `brand` FROM `productcategory`");
$products1 = array();
...
$result2 = mysqli_query($connect,"SELECT * FROM productcategory"); /*Запрос на выборку товаров из базы*/
$products2 = array();
